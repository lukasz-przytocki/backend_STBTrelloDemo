...
public class MoveCardBetweenListsTest extends BaseTest {
    ...
    public void createNewBoard() {
        ...
        assertThat(jsonPath.getString("name")).contains("My e2e board");
    ...
    public void createFirstList() {
        ...
        JsonPath jsonPath = response.jsonPath();
        assertThat(jsonPath.getString("name")).contains("First list");
    ...
    public void createSecondList() {
        ...
        JsonPath jsonPath = response.jsonPath();
        assertThat(jsonPath.getString("name")).contains("Second list");
    ...
    public void createCard() {
        Response response = given()
                ...
                .queryParam("desc", "Card created for test")
                .queryParam("idList", firstListId)
                .when()
                .post(BASIC_URL + "/" + CARDS)
                .then()
                .statusCode(200)
                .extract()
                .response();
        ...
        JsonPath jsonPath = response.jsonPath();
        assertThat(jsonPath.getString("name")).contains("My card");
    ...
    public void updateCard() {
        ...
        JsonPath jsonPath = response.jsonPath();
        assertThat(jsonPath.getString("idList")).contains(secondListId);
    ...
    public void deleteBoard() {
        given()
                .spec(reqSpec)
                .when()
                .delete(BASIC_URL + "/" + BOARDS +"/"+ boardId)
                .then()
                .statusCode(200);
